...
const PartnerLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 relative overflow-hidden">
      ...
      <div className="relative min-h-[calc(100vh-5rem)] flex items-center justify-center p-4 sm:p-6 lg:p-8 header-offset">
        ...
        <div className="relative z-10 w-full max-w-6xl grid lg:grid-cols-2 gap-6 sm:gap-8 items-center">
          ...
          >
            ...
            {/* Titre */}
            <div>
              <h1 className="text-4xl lg:text-5xl font-serif font-bold text-slate-100 mb-4 leading-tight">
          ...
          <motion.div 
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
            className="w-full bg-slate-900/80 backdrop-blur-xl border border-slate-800 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 shadow-2xl"
          >
            {/* Header formulaire */}
            <div className="text-center mb-6 sm:mb-8">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-purple-600 to-pink-600 rounded-2xl flex items-center justify-center mx-auto mb-4">
            ...
            <form onSubmit={handleLogin} className="space-y-4 sm:space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full bg-slate-950/50 border border-slate-800 text-slate-200 pl-11 pr-4 py-3 sm:py-4 text-sm sm:text-base rounded-xl focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    placeholder="••••••••"
                    className="w-full bg-slate-950/50 border border-slate-800 text-slate-200 pl-11 pr-11 sm:pr-12 py-3 sm:py-4 text-sm sm:text-base rounded-xl focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all"
              ...
              <button 
                type="submit" 
                disabled={loading}
                className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold py-3.5 sm:py-4 rounded-xl shadow-xl hover:shadow-2xl transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed mt-6 sm:mt-8 text-sm sm:text-base"
              >
                {loading ? (
                  <>
            ...
            <Link to="/partner/register">
              <button className="w-full bg-slate-800 hover:bg-slate-700 text-slate-200 font-bold py-3.5 sm:py-4 rounded-xl transition-all border border-slate-700 hover:border-purple-500/50 text-sm sm:text-base">
          ...
          <div className="lg:hidden w-full max-w-2xl mx-auto grid grid-cols-3 gap-2 sm:gap-3 mt-6 sm:mt-8">
            {[
              ...
              >
                <stat.icon className={`${stat.color} mx-auto mb-1`} size={18} />
                <h3 className="text-base sm:text-lg font-bold text-slate-100 mb-0.5">{stat.value}</h3>
                <p className="text-slate-500 text-[10px] sm:text-xs">{stat.label}</p>
              </motion.div>
            ))}
          </div>
        </div>
